    ...
    try {
      ...
      if (result.success) {
        ...
        const metadata: NFTMetadata = {
          name: `@${username}`,
          description: `Chat2Earn Username NFT for @${username}. This NFT represents ownership of the username on the Chat2Earn platform.`,
          image: generateUsernameNFTImage(username),
          attributes: [
            { trait_type: "Platform", value: "Chat2Earn" },
              ...
              >
                <div className="text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-text-muted">
                      Own your identity on Chat2Earn with a unique username NFT
                      that proves ownership and enables easy discovery.
                    </p>
                  </div>
                </div>
                  ...
                  {[
                    {
                      ...
                      desc: "Prove ownership",
                    },
                    {
                      icon: Zap,
                      title: "Easy Discovery",
                      desc: "Find friends easily",
                    },
                    {
                      icon: Gem,
                      title: "Tradeable NFT",
                ...
                <div className="bg-primary/10 border border-primary/20 rounded-lg p-4">
                  ...
                  <p className="text-sm text-text">
                    Claim your username NFT for only <strong>0.01 SOL</strong>{" "}
